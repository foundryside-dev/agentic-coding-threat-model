...
| 22 | `@int_data` + `@validates_shape` | Contradictory | Internal data uses restoration boundaries (§5.3), not the T4→T3 shape-validation mechanism designed for external input |
