...
| ID | Name | STRIDE | Failure Layer[^failure-layers] | Type | Relation[^relation-categories] | Risk | Detection | Portable Tool (Wardline)[^wardline-coverage] |
|----------|----------------------|------------|----------------|----------------|---------------|----------|-------------------|----------------|
...
| ACF-S3 | Structural Identity Spoofing | S[^s3-stride] | Training bias | Code Pattern | Agent-specific | High | Partial | Not covered (bespoke only) |
| ACF-T1 | Authority Tier Conflation | T | Training bias | Code Pattern | Agent-specific | Critical | None[^t1-detection] | Covered |
...
| ACF-R3 | Verification Displacement | R | Context collapse | Code Pattern | Agent-specific | High | Partial (R3a) / None (R3b)[^r3b-detection] | Not covered |
