---
title: Agent Autonomy Self-Assessment
sidebar:
  order: 1
---
...
- At Level 2: Can the team demonstrate awareness of [ACF patterns](../../acf/)? Is SAST augmented to cover the failure modes in the taxonomy, or is it standard-only?
