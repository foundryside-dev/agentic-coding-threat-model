...
!!! info "Reading this figure correctly"
...
!!! warning "Corrections don't persist"
...
Your delivery teams — and their contracted suppliers — are using these tools now. Two actions are immediately useful: (1) share the companion [Practical Guide](../respond/practical-guide.md) with teams who write or review code, so they know what to look for; (2) review your procurement and contracting arrangements against the trust-boundary questions this paper raises — existing procurement frameworks do not yet require controls at the delivery boundary. The case studies (§8 of the full paper) provide concrete examples: [Appendix D](paper.md#appendix-d-case-study-1-controlled-generation-of-a-government-assistance-application) shows a complete agent-built application with every finding cited to a line of code; [Appendix E](paper.md#appendix-e-case-study-2-agentic-failure-in-practice) presents annotated incidents from a compliance-constrained project.
...
!!! tip "You might also need"
    - **Assess your exposure** — [CISO Assessment](../assess/ciso-assessment.md) or [Assessor Checklist](../assess/irap-checklist.md)
    - **Take action** — [Practical Guide](../respond/practical-guide.md) for code review guidance
    - **Full analysis** — [Discussion Paper](paper.md) (~200 pages) for the complete technical treatment
