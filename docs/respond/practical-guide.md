...
!!! tip inline end "PDF version"
    [:material-file-pdf-box: Download PDF](../pdf/reviewing-ai-generated-code.pdf){ .md-button }
...
*This is the practical companion to [Governing AI-Generated Code: Semantic Risk in High-Stakes Code Paths](../understand/index.md) — that document explains the systemic risk; this one shows you what to look for in your code.*
