...
# Case Studies: What the Invisibility Problem Looks Like in Practice
...
For the full case study methodology, caveats, and replication protocol, see the [discussion paper Section 8](../understand/paper.md#8-case-studies-what-the-invisibility-problem-looks-like-in-practice).
...
*Full analysis: [Appendix D](../understand/paper.md#appendix-d-case-study-1-controlled-generation-of-a-government-assistance-application) in the discussion paper.*
...
*Full analysis: [Appendix E](../understand/paper.md#appendix-e-case-study-2-agentic-failure-in-practice) in the discussion paper.*
...
The failure modes map directly to the [ACF taxonomy](../understand/taxonomy.md). Three examples from the longitudinal project:
...
- **A detection mechanism for ACF-pattern violations** — at minimum, a small set of static analysis rules targeting the patterns in the [ACF taxonomy](../understand/taxonomy.md). The detection mechanism should be implemented and evaluated independently of the paper's author to reduce confirmation bias.
...
- [**Full Discussion Paper**](../understand/paper.md) — the complete case studies with methodology, caveats, and detailed findings
- [**ACF Taxonomy**](../understand/taxonomy.md) — the failure mode taxonomy referenced throughout the case studies
- [**Practical Guide**](practical-guide.md) — the five review questions with worked code examples for applying these lessons in your own work
