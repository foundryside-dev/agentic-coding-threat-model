...
- **The gate must declare its own epistemic status.** A baseline seeded with unadjudicated entries must say so in its own header and failure messages, so green reads as "nothing new landed," not "this corpus is correct" — a third epistemic state between "checked and clean" and "didn't look."
